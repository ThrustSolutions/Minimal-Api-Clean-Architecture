...
namespace MinimalApi.EndpointDefinitions
{
    public class PostEndpointDefinition : IEndpointDefinition
    {
        ...
        private static async Task<IResult> DeletePost(IMediator mediator, int id)
        {
        ...
        private static async Task<IResult> UpdatePost(IMediator mediator, Post post, int id)
        {
        ...
        private static async Task<IResult> CreatePost(IMediator mediator, Post post)
        {
        ...
        private static async Task<IResult> GetPostById(IMediator mediator, int id)
        {
